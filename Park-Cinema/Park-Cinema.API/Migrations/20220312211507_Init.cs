        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HallFormatType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BarsChoose = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Photo_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BranchLanguages_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_BranchLanguages_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarsChoose = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FilmProject = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HallFormatD = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LanguageId = table.Column<int>(type: "int", nullable: false),
                    BranchId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClaimerAge = table.Column<int>(type: "int", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Formats = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieContentLanguages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieContentLanguages_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MovieContentLanguages_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchLanguages_BranchId",
                table: "BranchLanguages",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_BranchLanguages_LanguageId",
                table: "BranchLanguages",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieContentLanguages_LanguageId",
                table: "MovieContentLanguages",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieContentLanguages_MovieId",
                table: "MovieContentLanguages",
                column: "MovieId");
